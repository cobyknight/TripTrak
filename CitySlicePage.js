...
const CitySlicePage = () => {
  ...
  const images = [
    { id: "01", image: require("./assets/CitySlicePage/csbar2.jpg") },
    { id: "02", image: require("./assets/CitySlicePage/csbar.jpg") },
    { id: "03", image: require("./assets/CitySlicePage/drinks.jpg") },
    { id: "04", image: require("./assets/CitySlicePage/drink.jpg") },
    { id: "05", image: require("./assets/CitySlicePage/insidedining.jpg") },
    { id: "06", image: require("./assets/CitySlicePage/outsidecs.jpg") },
    { id: "07", image: require("./assets/CitySlicePage/anotherdrink.jpg") },
  ];
  ...
  const goToWebsite = () => {
    ...
    Linking.openURL('https://www.cityslicepizza.com/');
  };

  const goToYelp = () => {
    Linking.openURL('https://www.yelp.com/biz_photos/city-slice-pizza-and-pints-baton-rouge');
  }
  ...
  const localsFavorites = [
    { image: require("./assets/CitySlicePage/meatpizza.jpg"), description: "Meat Pizza" },
    { image: require("./assets/CitySlicePage/smokedwings.jpg"), description: "Smoked Wings" },
    { image: require("./assets/CitySlicePage/mozsticks.jpg"), description: "Mozzarella Sticks" },
    { image: require("./assets/CitySlicePage/pizza.jpg"), description: "Everything Pizza" },
    { image: require("./assets/CitySlicePage/loadedtots.jpg"), description: "Loaded Tots" },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#1a1c21'}}>
      ...
      <ScrollView>
        ...
        <Text style={styles.title}>City Slice</Text>
        ...
        <View style={ styles.reviewTop }>
          ...
          <Text style={styles.review}>4.3 (316 Reviews)  $ ⋅ Pizza | Dining </Text>
          </View>
      ...
      <View key={index} style={styles.localsFavoriteItem}>
        ...
        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/CitySlicePage/anna.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Anna F.</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview1}>
          <Text numberOfLines={isReview1Expanded ? 0 : 2} style={styles.reviewComment}>The pizza is delicious and the service is good. We got the Heisman, garlic knots, and some vodka lemonades and really enjoyed everything. The staff was really nice and service was fast. I think everything's a bit too pricey but that's how I feel about every restaurant nowadays. I'd definitely come here more if it wasn't so expensive.</Text>
        ...
        <View style={styles.reviewContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Harun H.</Text>
            <Text style={styles.locationText}>Baton Rouge, LA</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview2}>
          <Text numberOfLines={isReview2Expanded ? 0 : 2} style={styles.reviewComment}>No explanation. Smoked Flavored Wings. Dine-in or Take-out which ever you prefer, during the times "City Slice Pizza and Pints" are Open. Check out the Website or Contact them via Phone Call.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>

        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/CitySlicePage/josh.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Josh M.</Text>
            <Text style={styles.locationText}>Baton Rouge, LA</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview3}>
          <Text numberOfLines={isReview3Expanded ? 0 : 2} style={styles.reviewComment}>I've only had the fighting tiger pizza, but I can say that I was pleasantly surprised by how tasty it was! It was loaded with lots of meat. The andouille, Italian sausage and bacon is what made it so tasty. The crust had good flavor and consistency as well. I can't speak for all the other pizzas or food, but the fighting tiger is a tasty meat pizza that I highly recommend. I hope to come back soon and order the exact same thing.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>
