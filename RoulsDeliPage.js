...
const RoulsDeliPage = () => {
  ...
  const images = [
    { id: "01", image: require("./assets/RoulsDeliPhotos/inside.jpg") },
    { id: "02", image: require("./assets/RoulsDeliPhotos/inside2.jpg") },
    { id: "03", image: require("./assets/RoulsDeliPhotos/insiderouls.jpg") },
    { id: "04", image: require("./assets/RoulsDeliPhotos/outsiderouls.jpg") },
    { id: "05", image: require("./assets/RoulsDeliPhotos/roulhimself.jpg") },
    { id: "06", image: require("./assets/RoulsDeliPhotos/rouls.jpg") },
    { id: "07", image: require("./assets/RoulsDeliPhotos/sign.jpg") },
  ];
  ...
  const goToWebsite = () => {
    ...
    Linking.openURL('https://roulsdeli.com/');
  };
  ...
  const localsFavorites = [
    { image: require("./assets/RoulsDeliPhotos/crawfisheggrolls.jpg"), description: "crawfish eggrolls" },
    { image: require("./assets/RoulsDeliPhotos/macncheeseeggrolls.jpg"), description: "Mac and Cheese Eggrolls" },
    { image: require("./assets/RoulsDeliPhotos/seafoodburger.jpg"), description: "Seafood Burger" },
    { image: require("./assets/RoulsDeliPhotos/hotwings.jpg"), description: "Hot Wings" },
    { image: require("./assets/RoulsDeliPhotos/steakandshrimpfries.jpg"), description: "Steak and Shrimp Fries" },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#1a1c21'}}>
      ...
      <ScrollView>
        ...
        <Text style={styles.title}>Roul's Deli</Text>
        ...
        <View style={ styles.reviewTop }>
          ...
          <Text style={styles.review}>4.2 (421 Reviews)      $ ⋅ Burger </Text>
          </View>

        <View style={styles.tScoreContainer}>
          <Text style={styles.tScoreText}>T-score: 1231</Text>
      ...
      <View key={index} style={styles.localsFavoriteItem}>
        ...
        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/RoulsDeliPhotos/staph.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Staphanie P.</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview1}>
          <Text numberOfLines={isReview1Expanded ? 0 : 2} style={styles.reviewComment}>My favorite thing to eat here are the crawfish egg rolls. That is more than enough, I don't order anything else to eat. 6 big rolls.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>

        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/RoulsDeliPhotos/Tiffany.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Tiffany T.</Text>
            <Text style={styles.locationText}>Fresno, TX</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview2}>
          <Text numberOfLines={isReview2Expanded ? 0 : 2} style={styles.reviewComment}>Crawfish egg rolls....who knew this combination will be full of deliciousness fried and made to order. My momma and I drove to the Highland location and parking was a beast!!!! But luckily after driving around 3 times, there was a parallel spot available. This creamy, cheesy delight comes in 6 cut pieces ready to dive in without the ranch.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>

        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/RoulsDeliPhotos/Brea.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Brea G.</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview3}>
          <Text numberOfLines={isReview3Expanded ? 0 : 2} style={styles.reviewComment}>Good southern food!! Glad it's placed around LSU. I would like to say I wish they had better fries. I only get their onion rings, because sometimes their fries can be hard, but the burgers are fantastic. I recommend the Philly burger.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>
