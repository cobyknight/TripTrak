...
const TheChimesPage = () => {
  ...
  const images = [
    { id: "01", image: require("./assets/ChimesPhotos/outsideview.jpg") },
    { id: "02", image: require("./assets/ChimesPhotos/bar.jpg") },
    { id: "03", image: require("./assets/ChimesPhotos/pretty.jpg") },
    { id: "04", image: require("./assets/ChimesPhotos/balcony.jpg") },
    { id: "05", image: require("./assets/ChimesPhotos/bararea.jpg") },
    { id: "06", image: require("./assets/ChimesPhotos/diningroom.jpg") },
    { id: "07", image: require("./assets/ChimesPhotos/beer.jpg") },
  ];
  ...
  const goToWebsite = () => {
    ...
    Linking.openURL('https://thechimes.com/');
  };

  const goToYelp = () => {
    Linking.openURL('https://www.yelp.com/biz/chimes-restaurant-baton-rouge');
  }
  ...
  const localsFavorites = [
    { image: require("./assets/ChimesPhotos/shrimpplatter.jpg"), description: "Shrimp Platter" },
    { image: require("./assets/ChimesPhotos/redbeansandrice.jpg"), description: "Red Beans and Rice" },
    { image: require("./assets/ChimesPhotos/crawfishetouffee.jpg"), description: "Crawfish Etouffee" },
    { image: require("./assets/ChimesPhotos/boudineggrolls.jpg"), description: "Boudin Eggrolls" },
    { image: require("./assets/ChimesPhotos/alligator.jpg"), description: "Alligator Bites" },
  ];
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#1a1c21'}}>
      ...
      <ScrollView>
        ...
        <View style={ styles.reviewTop }>
          ...
          <FontAwesome name="star" size={20} color="#FFA500" />
          <FontAwesome name="star" size={20} color="#FFA500" />
          <FontAwesome name="star-o" size={20} color="#FFA500" />
          <Text style={styles.review}>4.1 (948 Reviews)   $ ⋅ Cajun | Dining </Text>
          </View>

        <View style={styles.tScoreContainer}>
          <Text style={styles.tScoreText}>T-score: 1121</Text>
      ...
      <View key={index} style={styles.localsFavoriteItem}>
        ...
        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/ChimesPhotos/Susie.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Susie G.</Text>
            <Text style={styles.locationText}>Winston-Salem, NC</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview1}>
          <Text numberOfLines={isReview1Expanded ? 0 : 2} style={styles.reviewComment}>Seeking to provide me with a taste of Louisiana experience, my Louisiana friends to me to lunch at Chimes so I could eat a Po' Boy. Apparently for the authentic experience, the sandwich needs to be made on a certain type of bread, and Chimes uses the proper bread. It's a type of French bread made with less flour and more water, lighter and fluffier than traditional French bread. I ordered the Shrimp Po' Boy. If you order it "dressed," it comes with mayonnaise, ketchup, pickles, lettuce and tomato. I asked for mine with only lettuce added. The bread was indeed lovely, just slightly crisp on the outside and very soft (but not mushy) on the inside. The shrimp was lightly breaded and very tasty. The sandwich came with a side of fries, which were delicious. Chimes is located just outside the LSU campus and is a preferred location on game days. On this midweek day in July the atmosphere was energized but fairly subdued. Service was quick and polite.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>

        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/ChimesPhotos/Haley.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Haley P.</Text>
            <Text style={styles.locationText}>Pittsburgh, PA</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview2}>
          <Text numberOfLines={isReview2Expanded ? 0 : 2} style={styles.reviewComment}>Had a nice early dinner here, I got the Caesar salad with chicken and my boyfriend got a bacon cheeseburger. We split the fried mozzarella as an app and that was my favorite item. They have 80 beers on draft plus a selection of cans and bottles for everyone's taste. Their rooftop bar is super cute too, we went up for another drink after our meal. Service was quick and friendly!</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>
        ...
        <View style={styles.reviewContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Alejandro M.</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview3}>
          <Text numberOfLines={isReview3Expanded ? 0 : 2} style={styles.reviewComment}>The best restaurant service ever. I got seated very quickly and took more order immediately which was amazing. Providing excellent service in quick time. This is one of best seafood places i've ever eaten in baton rouge. I ordered the shrimp poboy and it was one of the things that I enjoyed most of the restaurant. After eating the desert this proved to me this is the best place for good and nice service.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>
