...
const TioJavisPage = () => {
  ...
  const images = [
    { id: "01", image: require("./assets/TioJavisPhotos/tiosoutside.jpg") },
    { id: "02", image: require("./assets/TioJavisPhotos/tiosnight.jpg") },
    { id: "03", image: require("./assets/TioJavisPhotos/tios.jpg") },
    { id: "04", image: require("./assets/TioJavisPhotos/tioinside.jpg") },
    { id: "05", image: require("./assets/TioJavisPhotos/good.jpg") },
    { id: "06", image: require("./assets/TioJavisPhotos/foodtios.jpg") },
    { id: "07", image: require("./assets/TioJavisPhotos/carne.jpg") },
  ];
  ...
  const goToWebsite = () => {
    ...
    Linking.openURL('https://tiojavis.com/');
  };

  const goToYelp = () => {
    Linking.openURL('https://www.yelp.com/biz/t%C3%ADo-javis-fresh-mex-bar-and-grill-baton-rouge');
  }
  ...
  const localsFavorites = [
    { image: require("./assets/TioJavisPhotos/steakfajitas.jpg"), description: "Steak Fajitas" },
    { image: require("./assets/TioJavisPhotos/churros.jpg"), description: "Churros" },
    { image: require("./assets/TioJavisPhotos/chickenquesadillas.jpg"), description: "Chicken Quesadilla" },
    { image: require("./assets/TioJavisPhotos/margs.jpg"), description: "Margaritas" },
    { image: require("./assets/TioJavisPhotos/shrimptacos.jpg"), description: "Shrimp Tacos" },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#1a1c21'}}>
      ...
      <ScrollView>
        ...
        <Text style={styles.title}>Tio Javi's Mexican Grill</Text>
        ...
        <View style={ styles.reviewTop }>
          ...
          <Text style={styles.review}>4.3 (139 Reviews)  $ ⋅ Mexican | Bar </Text>
          </View>

        <View style={styles.tScoreContainer}>
          <Text style={styles.tScoreText}>T-score: 1050</Text>
      ...
      <View key={index} style={styles.localsFavoriteItem}>
        ...
        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/TioJavisPhotos/tanya.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Tanya A.</Text>
        ...
        <TouchableWithoutFeedback onPress={expandReview1}>
          <Text numberOfLines={isReview1Expanded ? 0 : 2} style={styles.reviewComment}>Our first time at this place and it didn't disappoint us. Our waitress, Jenifer, was very nice and attentive to us. Her suggestions were amazing and we chose the fajitas after her description. We loved the salsas! We ordered steak fajitas and we were surprised with all the sides, rice, charro beans, queso, guacamole, sour cream, pico and house made tortillas. It was an excellent choice and we were very satisfied. Also, we ordered the house margaritas, a bit to sweet for us, but ok. Definitely, we'll be back.</Text>
        ...
        <View style={styles.reviewContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Jennifer T.</Text>
            <Text style={styles.locationText}>LA, LA</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview2}>
          <Text numberOfLines={isReview2Expanded ? 0 : 2} style={styles.reviewComment}>Went the other night and it was delicious! I got the fajitas and they tasted good. My server was Alyssa and she was fantastic! Answered all my questions and was quick with the service. Will definitely be coming back!</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>

        <View style={styles.reviewContainer}>
          <View style={styles.imageContainer}>
            <Image source={require('./assets/TioJavisPhotos/Brian.jpg')} style={styles.image} />
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Brian S.</Text>
            <Text style={styles.locationText}>Las Vegas, NV</Text>
            <View style={styles.reviewCommentRating}>
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
              <FontAwesome name="star" size={15} color="#FFA500" />
        ...
        <TouchableWithoutFeedback onPress={expandReview3}>
          <Text numberOfLines={isReview3Expanded ? 0 : 2} style={styles.reviewComment}>We came in for dinner tonight and I ordered the three tacos, rice and beans. These tacos were super delicious and fresh. I highly recommend getting the tacos with ground beef. The flavor was fantastic. The best part of our evening with our service by Alejandra. She made our evening perfect...the service was excellent, efficient, and fun. Alejandra's personality made our evening great. I highly recommend requesting Alejandra if you want perfect Service. Inside the restaurant was super clean, bathrooms are clean, and just an all-around super fun environment.</Text>
        </TouchableWithoutFeedback>
        <View style={styles.line}/>
